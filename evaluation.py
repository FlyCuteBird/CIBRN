...
def evalrank(model_path, data_path=None, split='dev', fold5=False):
    ...
    if not fold5:
        ...
        np.save(path + '%s_%s_sim.npy' % (opt.Matching_direction, opt.Add_features), sims)
        ...
        for i in range(5):
            ...
            sims = shard_xattn(model, img_embs_shard, cap_embs_shard,
                              cap_lens_shard, opt, shard_size=80)
...
def shard_xattn(model, images, captions, caplens, opt, shard_size=128):
    """
